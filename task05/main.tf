...
import {
  to = module.resource_groups["rg1"].azurerm_resource_group.rg
  id = "/subscriptions/fe7f3f41-b0fa-47c8-84f7-d5e8ae76595f/resourceGroups/cmaz-ac643e5v-mod5-rg-01"
}

import {
  to = module.resource_groups["rg2"].azurerm_resource_group.rg
  id = "/subscriptions/fe7f3f41-b0fa-47c8-84f7-d5e8ae76595f/resourceGroups/cmaz-ac643e5v-mod5-rg-02"
}

import {
  to = module.resource_groups["rg3"].azurerm_resource_group.rg
  id = "/subscriptions/fe7f3f41-b0fa-47c8-84f7-d5e8ae76595f/resourceGroups/cmaz-ac643e5v-mod5-rg-03"
}
